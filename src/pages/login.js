        ...
        <div>
            ...
            <main className="py-20 flex justify-center items-center text-center">
                <div className="flex flex-col w-full md:w-[600px]">
                    ...
                    <div className="bg-gray-800 rounded shadow-md p-10 mb-2">
                        ...
                        <div className="text-left">
                            <div className="flex items-center mb-2">
                                ...
                                <input className="bg-white rounded text-black text-sm md:text-base h-10 md:h-12 px-2 ml-2 shadow-md w-full" type="text" placeholder="Enter your email" />
                            </div>
                            <div className="flex items-center mt-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6 text-white">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 5.25a3 3 0 0 1 3 3m3 0a6 6 0 0 1-7.029 5.912c-.563-.097-1.159.026-1.563.43L10.5 17.25H8.25v2.25H6v2.25H2.25v-2.818c0-.597.237-1.17.659-1.591l6.499-6.499c.404-.404.527-1 .43-1.563A6 6 0 1 1 21.75 8.25Z" />
                                </svg>
                                <input className="bg-white rounded text-black text-sm md:text-base h-10 md:h-12 px-2 ml-2 shadow-md w-full" type="text" placeholder="Enter your password" />
                            </div>
                    ...
                    <div>
                        <div>
                            <a className="bg-gray-800 text-white inline-flex items-center h-10 md:h-12 w-full md:w-[300px] justify-center text-center rounded text-sm md:text-base pt-1 transition ease-out hover:scale-105 shadow-md shadow-gray-400" href="/">Log In</a>
                        </div>
                    </div>
                </div>
            </main>
